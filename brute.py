...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              Assalamu'@M4STER_MIND. ^_^")
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Mujtaba Azar             |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |            FACEBOOK: MujtabaAzar            |"
    print Y+"  |             telegram: @M4STER_MIND           |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        LIFE OF PROGRAMMER [ LEADER</> ]     |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   HACK FACEBOOK MA ^_^    •••••••••|"
    print GG+"  √=============================================√"
